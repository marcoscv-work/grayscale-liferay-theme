...
<section id="about" class="about-section text-center">
    ...
    <img src="https://blackrockdigital.github.io/startbootstrap-grayscale/img/ipad.png" class="img-fluid" alt="">
    </div>
</section>
...
<section id="signup" class="signup-section">
    ...
    <div class="row">
        ...
        <form class="form-inline d-flex">
            <input type="email" class="form-control col mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputEmail" placeholder="Enter email address...">
